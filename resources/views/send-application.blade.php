                                    ...
                                    <div class="flex max-w-lg justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6">
                                        <div class="space-y-1 text-center">
                                            ...
                                            <div class="flex text-sm text-gray-600">
                                                <span class="relative cursor-pointer rounded-md bg-white font-medium text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:text-indigo-500">
                                                    <span>Envie o seu currículo</span>
                                                    <input name="file" type="file" class="sr-only">
                                                </span>
                                                <p class="pl-1">ou arraste e solte aqui</p>
                                            </div>

                                            <p class="text-xs text-gray-500">doc, docx ou pdf de até 1MB</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
